...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="everforest"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/cj/49s0qc3s3ls4gz76gb29r5dm0000gn/0//com.apple.notificationcenter/db2/db" 'select * from app'
