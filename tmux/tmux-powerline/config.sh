...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/xz/927_qvtd533fszqdc7d1_7x00000gn/0//com.apple.notificationcenter/db2/db" 'select * from app'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/catay/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/catay/.mailcheckrc"
# }
